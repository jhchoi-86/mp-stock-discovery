...
if (require.main === module) {
    ...
    async function getKisAccessToken() {
        ...
        // [Red Team] Add timeout to prevent hanging on token acquisition
    ...
    async function fetchOhlc(token, code, tf = '1D') {
        ...
        const res = await axios.get(url, {
            ...
            timeout: 5000 // [Red Team] Network isolation / long-hang protection
        });
            ...
            for (const tf of targetTfs) {
                ...
                for (let i = 0; i < stocks.length; i++) {
                    ...
                    try {
                        ...
                        // [Red Team] Increased from 250ms to 1000ms to stay within limits on restricted accounts
