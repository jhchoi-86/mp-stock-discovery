  ...
  return (
    <div className="modal-overlay" style={{
      ...
      <div className="modal-content fade-in" style={{ 
        maxWidth: '650px', width: '90%', padding: '2rem', textAlign: 'center',
        ...
        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', justifyContent: 'center' }}>
          {/* Free Plan */}
          <div style={{ flex: '1 1 250px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '12px', padding: '1.5rem', textAlign: 'left' }}>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: '0.85rem', color: 'rgba(255,255,255,0.8)', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          ...
          {/* Premium Plan */}
          <div style={{ flex: '1 1 250px', background: 'linear-gradient(145deg, rgba(99,102,241,0.1), rgba(236,72,153,0.1))', border: '1px solid var(--primary)', borderRadius: '12px', padding: '1.5rem', textAlign: 'left', position: 'relative' }}>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: '0.85rem', color: '#fff', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
