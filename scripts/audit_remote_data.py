...
print("--- Remote Audit: landing_strategy.json ---")
res2 = run_ssh("node -e \"const b=require('./data/landing_strategy.json'); console.log(JSON.stringify(b.top5||b.stocks||b,null,2))\" | head -20")
sys.stdout.buffer.write(res2.stdout)

print("\n--- Remote Audit: latest.json ---")
res3 = run_ssh("node -e \"const a=require('./data/vip_logs/latest.json'); console.log(JSON.stringify(a.top5||a.stocks||a,null,2))\" | head -20")
